...
class assignment2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("James Gosling",style: TextStyle(
          color: Colors.white,
        ),),
        backgroundColor: const Color.fromARGB(255, 100, 33, 243),
      ),
        backgroundColor: const Color.fromARGB(255, 237, 157, 184),
        body:  Container(
        child: Column(
